...
mov r4, OUT
set 2
rot r4, OUT  // Right rotate to 0b0100_0000
...
mov r4, 3
rot OUT, r4  // Right rot OUT to 0b0010_0000
...
// Fix with parity register par
mov r4, 4
rot OUT, r4  // Turns OUT to 0b0001_0000
...
mov r2, OUT
mov r4, 7
rot r3, r4          // Stores r3 rotated by 7 in OUT
mov r4, 0b00000001
and r4, OUT
...
mov OUT, 0b00000001
and r2, OUT
//TODO Check validity of statement
mov r5, 5
rot OUT, r5
...
mov r5, 10
rot OUT, r5	//Rotates by 10 to get into lowest bit first
