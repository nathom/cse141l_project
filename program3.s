...
# Note: need to fix some incorrect operands and one of the comments creates a Unicode error
...
set if2
mov r5, 1
beq r1, r5              // If (occurred) byte_count++           
...
set if3
mov r5, 31
beq r0, r5              // if(i != 31), branch when i = 31
...
orr OUT, r1             // OUT = ((b & 0000_1111) << 1) | (mem[i + 1] rrt(7) & 0b00000001)
