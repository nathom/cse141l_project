...
vlog -sv -work work +incdir+W:/src {W:/src/reg_file.sv}
vlog -sv -work work +incdir+W:/src {W:/src/dat_mem.sv}
vlog -sv -work work +incdir+W:/src {W:/src/Control.sv}
vlog -sv -work work +incdir+W:/src {W:/src/alu.sv}
vlog -sv -work work +incdir+W:/src {W:/src/PC.sv}
vlog -sv -work work +incdir+W:/src {W:/src/instr_ROM.sv}
vlog -sv -work work +incdir+W:/src {W:/src/top_level.sv}

vlog -sv -work work +incdir+W:/src {W:/src/top_level_tb.sv}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  top_level_tb
